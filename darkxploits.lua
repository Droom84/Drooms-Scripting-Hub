...
local Window = Rayfield:CreateWindow({
   ...
   KeySettings = {
      ...
      Key = {"DarkXploits-Affiliate-G324G234"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
   }
})
